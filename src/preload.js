...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Écouteur pour les données en temps réel de PS1
  onPS1Output: (callback) => {
    ipcRenderer.on('ps1-output', callback);
  },
  
  // Supprimer l'écouteur PS1
  removePS1OutputListener: () => {
    ipcRenderer.removeAllListeners('ps1-output');
  },
